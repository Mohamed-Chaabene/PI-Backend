...
public class FreelanceController {
    ...
    public ResponseEntity<CandidatureResponseDTO> postuler(
            @PathVariable Long id,
            Principal principal) {
        return ResponseEntity.ok(candidatureService.postuler(id, principal.getName()));
    }
    ...
    public ResponseEntity<CandidatureResponseDTO> accepterCandidature(@PathVariable Long id) {
    ...
    public ResponseEntity<CandidatureResponseDTO> rejeterCandidature(@PathVariable Long id) {
        return ResponseEntity.ok(candidatureService.rejeterCandidature(id));
    }
}